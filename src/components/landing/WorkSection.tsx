...
/*         {
    ...
    return (
        <section id="work" className="px-24 mt-40">
            <h1 className="text-foreground font-bold text-6xl mb-12">Selected work</h1>
            ...
            <div className="flex flex-row justify-center">
                <button className="cursor-pointer my-20 px-24 py-3 bg-foreground text-white rounded-4xl hover:bg-secondary transition-colors">
                    See more
                </button>
            </div>
        </section>
